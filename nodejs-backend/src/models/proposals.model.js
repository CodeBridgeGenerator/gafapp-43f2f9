    ...
    module.exports = function (app) {
        ...
        const schema = new Schema(
          {
            proposalRef: { type:  String , required: true, comment: "Proposal Ref, p, false, true, true, true, true, true, true, , , , ," },
proposalName: { type:  String , required: true, comment: "Proposal Name, p, false, true, true, true, true, true, true, , , , ," },
