const { ProposalRef } = require("./proposalRef.class");
const createModel = require("../../models/proposalRef.model");
const hooks = require("./proposalRef.hooks");
...
module.exports = function (app) {
  ...
  app.use("/proposalRef", new ProposalRef(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("proposalRef");

  // Get the schema of the collections 
  app.get("/proposalRefSchema", function (request, response) {
