const { ProjectProposals } = require("./projectProposals.class");
const createModel = require("../../models/projectProposals.model");
const hooks = require("./projectProposals.hooks");
...
module.exports = function (app) {
  ...
  app.use("/projectProposals", new ProjectProposals(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("projectProposals");

  // Get the schema of the collections 
  app.get("/projectProposalsSchema", function (request, response) {
