const { Proposals } = require("./proposals.class");
const createModel = require("../../models/proposals.model");
const hooks = require("./proposals.hooks");
...
module.exports = function (app) {
  ...
  app.use("/proposals", new Proposals(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("proposals");

  // Get the schema of the collections
  app.get("/proposalsSchema", function (request, response) {
