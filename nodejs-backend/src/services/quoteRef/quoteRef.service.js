const { QuoteRef } = require("./quoteRef.class");
const createModel = require("../../models/quoteRef.model");
const hooks = require("./quoteRef.hooks");
...
module.exports = function (app) {
  ...
  app.use("/quoteRef", new QuoteRef(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("quoteRef");

  // Get the schema of the collections 
  app.get("/quoteRefSchema", function (request, response) {
