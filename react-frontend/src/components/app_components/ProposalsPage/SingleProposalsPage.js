...
const SingleProposalsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("proposals")
      .get(urlParams.singleProposalsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Proposal Ref</label>
                <p className="m-0 ml-3">{_entity?.proposalRef}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Proposal Name</label>
                <p className="m-0 ml-3">{_entity?.proposalName}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Due Date</label>
                <p id="dueDate" className="m-0 ml-3">
                  {_entity?.dueDate}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
