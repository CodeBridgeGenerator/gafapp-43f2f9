...
import seederData from "./proposals.seeder.json";
...
const ProposalsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProposalsSeederDialogComponent);
