...
remarks: _entity?.remarks,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info projectProposals updated successfully" });
...
const approvedByOptions = approvedBy.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit ProjectProposals" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="projectProposals-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(ProjectProposalsEditDialogComponent);
