...
import seederData from "./projectProposals.seeder.json";
...
const ProjectProposalsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProjectProposalsSeederDialogComponent);
