...
import seederData from "./quotes.seeder.json";
...
const QuotesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QuotesSeederDialogComponent);
