...
file: _entity?.file,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info quotes updated successfully" });
...
const approvedByOptions = approvedBy.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Quotes" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="quotes-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="applicationCost" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.applicationCost} onValueChange={(e) => setValByKey("applicationCost", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="supportCost" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.supportCost} onValueChange={(e) => setValByKey("supportCost", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="firstMilestonePayment" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.firstMilestonePayment} onValueChange={(e) => setValByKey("firstMilestonePayment", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="secondMilestonePayment" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.secondMilestonePayment} onValueChange={(e) => setValByKey("secondMilestonePayment", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="thirdMilestonePayment" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.thirdMilestonePayment} onValueChange={(e) => setValByKey("thirdMilestonePayment", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="fourthMilestonePayment" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.fourthMilestonePayment} onValueChange={(e) => setValByKey("fourthMilestonePayment", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="fifthMilestonePayment" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.fifthMilestonePayment} onValueChange={(e) => setValByKey("fifthMilestonePayment", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="applicationCostSST" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.applicationCostSST} onValueChange={(e) => setValByKey("applicationCostSST", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="supportCostSST" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.supportCostSST} onValueChange={(e) => setValByKey("supportCostSST", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="revision" className="w-full mb-3 p-inputtext-sm" value={_entity?.revision} onChange={(e) => setValByKey("revision", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'edit'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleQuotesId} serviceName="quotes" />
                </span>
                <small className="p-error">
