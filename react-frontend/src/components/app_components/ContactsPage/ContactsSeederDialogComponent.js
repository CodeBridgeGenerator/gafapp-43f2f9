...
import seederData from "./contacts.seeder.json";
...
const ContactsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContactsSeederDialogComponent);
