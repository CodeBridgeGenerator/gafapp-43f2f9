...
const ContactsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            company: _entity?.company?._id,contactName: _entity?.contactName,position: _entity?.position,linkedIn: _entity?.linkedIn,
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="contactName" className="w-full mb-3 p-inputtext-sm" value={_entity?.contactName} onChange={(e) => setValByKey("contactName", e.target.value)}  required  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="linkedIn" className="w-full mb-3 p-inputtext-sm" value={_entity?.linkedIn} onChange={(e) => setValByKey("linkedIn", e.target.value)}  required  />
            </span>
            <small className="p-error">
