    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Contact Name"
          body={pTemplate1}
          filter={selectedFilterFields.includes("contactName")}
          hidden={selectedHideFields?.includes("contactName")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          header="LinkedIn"
          body={pTemplate3}
          filter={selectedFilterFields.includes("linkedIn")}
          hidden={selectedHideFields?.includes("linkedIn")}
          sortable
          style={{ minWidth: "8rem" }}
        />
