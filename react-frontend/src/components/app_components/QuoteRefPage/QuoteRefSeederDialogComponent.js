...
import seederData from "./quoteRef.seeder.json";
...
const QuoteRefSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(QuoteRefSeederDialogComponent);
