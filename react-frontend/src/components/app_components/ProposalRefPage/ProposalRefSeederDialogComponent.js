...
import seederData from "./proposalRef.seeder.json";
...
const ProposalRefSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProposalRefSeederDialogComponent);
